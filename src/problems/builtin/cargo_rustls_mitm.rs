use crate::problems::schema::{Problem, SourcePatternSet, SourcePattern, Confidence};
...
pub fn problem() -> Problem {
    Problem {
        ...
        references: vec![
            "https://rustsec.org/advisories/RUSTSEC-2024-0336.html".into(),
        ],
        source_patterns: Some(SourcePatternSet {
            ...
            patterns: vec![
                SourcePattern {
                    ...
                    remediation: "Upgrade rustls to >=0.23.5. If using CRL-based revocation, this is a definite risk.".into(),
                },
            ],
        }),
    }
